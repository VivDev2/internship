...
import mhlogo from '../assets/mhlogo.jpeg'
  ...
  const handleNav = () =>
   ...
   return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
        <h1 className='w-full text-3xl font-bold text-[#f7f8f8]'>MHTECHIN</h1>
        
        <ul className=' hidden md:flex'>
            <li className='p-4 hover:cursor-pointer '>Home</li>
            <li className='p-4 hover:cursor-pointer'>Bolgs</li>
        ...
        <div className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500' :'fixed left-[-100%]'}>
         <h1 className='w-full text-3xl font-bold text-[#00df98] m-4'>REACT</h1>
            ...
            <li className='p-4 border-b border-gray-600'>Bolgs</li>
